...
const CartItems = ({item, itemIndex}) => {
  ...
  return (
    <div className='flex items-center p-5 justify-between mt-2 mx-5 border-b-[3px] border-slate-500'>
    <div className='flex flex-row p-3 gap-5 items-center'>
       ...
       <div className='w[70%] self-start space-y-5 ml-5'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <button className='text-red-800 bg-red-200 group hover:bg-red-400 
          transition-transform duration-300 cursor-pointer rounded-full p-3 mr-3' onClick={removeFromCart}>
             <FcDeleteDatabase />
          </button>
